    ...
    return (
        <ClientsCard>
            <div>
                <Formik
                    initialValues={{
                        stClient: { Status: 'Activo' }, client: {
                            RFC: '', Cliente: '', Contacto: '', Telefono: '', Celular: '',
                            Estado: '', Ciudad: '', Direccion: '', Cp: '', Observaciones: '', Email: '', FechaReg: date
                        }, sucursals: { Nombre: '', Direccion: '' }
                    }}
                    ...
                    {({ values, isSubmitting, handleChange, handleBlur, handleSubmit }) => (
                        <form onSubmit={handleSubmit} autoComplete="off">
                            ...
                            <ButtonsStyle>
                                ...
                                <Button className="btn2" onClick={handleClose}>Cancelar</Button>
                            </ButtonsStyle>
