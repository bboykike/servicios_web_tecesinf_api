...
const ImageForm = ({ servicios, setEvidenciaOpen }) => {
  //Variables
  const Ser = { servicios }
  const id = Ser.servicios.IDServiceSE
  ...
  return (
    <ImagenCard>
      ...
      <Grid align="center" container spacing={3}>
        ...
        <br />
        <Grid item xs={12}>
          <Button type="submit" onClick={handleSave} color="primary">Guardar</Button>
          <Button type="submit" onClick={close} color="primary">Cerrar</Button>
        </Grid>
      </Grid>
    </ImagenCard>
  )
